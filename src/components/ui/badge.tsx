...
const badgeVariants = cva({
  ...
  variants: {
    variant: {
      default:
        'border-transparent bg-primary text-primary-foreground [a&,button&]:hover:bg-primary/75',
      secondary:
        'border-transparent bg-secondary text-secondary-foreground [a&,button&]:hover:bg-secondary/40',
      destructive:
        'border-transparent bg-destructive text-white focus-visible:ring-destructive/20 dark:bg-destructive/60 dark:focus-visible:ring-destructive/40 [a&]:hover:bg-destructive/90',
      outline: 'text-foreground [a&]:hover:bg-accent [a&]:hover:text-accent-foreground',
      tag: 'border-sky-800 bg-sky-800/40 text-sky-200',
    },
  },
  defaultVariants: {
    variant: 'default',
